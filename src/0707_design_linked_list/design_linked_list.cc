// author: yqq
// date: 2021-09-15 16:08:04
// descriptions: https://leetcode-cn.com/problems/design-linked-list
#include <bits/stdc++.h>
#include <iostream>
#include <numeric>
#include <vector>
...
public:
    ...
    MyLinkedList()
    {
        dumyHead = new ListNode(-1, nullptr);
    }
    ...
    {
        ListNode *node = new ListNode(val, dumyHead->next);
        dumyHead->next = node;
    }
